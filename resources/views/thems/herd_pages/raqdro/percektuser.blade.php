                                    ...
                                    <ul class="d-flex flex-column-reverse todo-list">
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="altraod"
                                                           @if(isset($pasux->altraod) && $pasux->altraod == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    ალტერნატივობის რაოდენობა
                                                </label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="pirveliaso"
                                                           @if(isset($pasux->pirveliaso) && $pasux->pirveliaso == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    პირველი ასო
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="meoreaso"
                                                           @if(isset($pasux->meoreaso) && $pasux->meoreaso == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    მეორე ასო
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="mesameaso"
                                                           @if(isset($pasux->mesamegilak) && $pasux->mesamegilak == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    მესამე ასო
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="meotxeaso"
                                                           @if(isset($pasux->meotxeaso) && $pasux->meotxeaso == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    მეოთხე ასო
                                    ...
                                    <div class="couples-holder">
                                        <div class="couples">
                                            <div class="form-group">
                                                ...
                                                <select name="xgerdzi[]">
                                                    <option value=""></option>
                                                    <option value="altraod">ალტერნატივობის რაოდენობა</option>
                                                    <option value="pirveliaso">პირველი ასო</option>
                                                    <option value="meoreaso">მეორე ასო</option>
                                                    <option value="mesameaso">მესამე ასო</option>
                                                    <option value="meotxeaso">მეოთხე ასო</option>
                                                    <option value="momxpasux">სისწორე</option>
                                                    <option value="upasuxtuara">უპასუხა თუ არა</option>
                                                    <option value="pasuxdro">რეაქციის დრო</option>
                                                    <option value="sworipasux">მომხმარებლის პასუხი</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
