                                                ...
                                                @foreach($testviuv as $i => $testviuvitem)
                                                    @if(isset($testviuvitem->title))
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1">
                                                                <a href="{{route('raqdro.user',['upid'=>$testviuvitem->id])}}">
                                                                    <button type="button"
                                                            ...
                                                            <td class="sorting_1">
                                                                <a href="{{route('user.raqdro',['upid'=>$testviuvitem->id])}}">
                                                                    <button type="button"
                                                                            class="btn btn-primary btn-rounded btn-fw"><span
                                                                            class="mdi mdi-file-document-edit"></span>
                                                                        პასუხები
                                                            ...
                                                            <td class="sorting_1">
                                                                <a href="{{route('edit.raqdro',['upid'=>$testviuvitem->id])}}">
                                                                    <button type="button"
                                                                            class="btn btn-primary btn-rounded btn-fw"><span
                                                                            class="mdi mdi-file-document-edit"></span>
                                                                        რედაქტირება
                                                            ...
                                                            <td>
                                                                <a href="{{route('dell.raqdro',['upid'=>$testviuvitem->id])}}">
                                                                    <button type="button"
