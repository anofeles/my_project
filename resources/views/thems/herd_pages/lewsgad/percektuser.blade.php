                                    ...
                                    <ul class="d-flex flex-column-reverse todo-list">
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="testaso"
                                                           @if(isset($pasux->testaso) && $pasux->testaso == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    სატესტო სტიმული
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="gradusi"
                                                           @if(isset($pasux->gradusi) && $pasux->gradusi == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    ბრუნვის კუთხე
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="revers"
                                                           @if(isset($pasux->revers) && $pasux->revers == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    სტიმულის სახე
                                    ...
                                    <div class="couples-holder">
                                        <div class="couples">
                                            <div class="form-group">
                                                ...
                                                <select name="xgerdzi[]">
                                                    <option value=""></option>
                                                    <option value="testaso">სატესტო სტიმული</option>
                                                    <option value="gradusi">ბრუნვის კუთხე</option>
                                                    <option value="revers">სტიმულის სახე</option>
