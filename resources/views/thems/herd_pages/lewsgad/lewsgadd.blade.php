    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-sample" method="post" action="{{route('lewsgad.test.add')}}">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                ...
                @if(isset($swori[0]) && !empty($swori[0]))
                    <div class="row">
                        <div class="table-sorter-wrapper col-lg-12 table-responsive">
                            <form method="post" action="{{route('lewsgad.testpart.add')}}">
                                @csrf
                                ...
                                <table id="sortable-table-2" class="table table-striped">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th class="sortStyle">ზედა სიტყვა<i class="mdi mdi-chevron-down"></i></th>
                                        <th class="sortStyle">ქვედა სიტყვა<i class="mdi mdi-chevron-down"></i></th>
{{--                                        <th class="sortStyle">ქვედა სიტყვა<i class="mdi mdi-chevron-down"></i></th>--}}
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($swori as $i => $sworiitem)
                                        <tr>
                                            <td>{{$i+1}}</td>
                                            <td><input value="{{$sworiitem['zeda']}}" class="form-control" name="zeda[]"></td>
                                            <input type="hidden" value="{{$sworiitem['varinat']}}" class="form-control" name="varinat[]">
                                            <td><input value="{{$sworiitem['qveda']}}" class="form-control"
                                                       name="qveda[]"></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
