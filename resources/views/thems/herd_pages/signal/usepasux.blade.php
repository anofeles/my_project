                                ...
                                <div class="table-sorter-wrapper col-lg-12 table-responsive">
                                    <table id="sortable-table-2" class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sortStyle">იხილეთ პასუხები<i class="mdi mdi-chevron-down"></i>
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                @if(isset($usertoaniitem[0]->id))
                                                    <tr>
                                                        ...
                                                        <td class="jsgrid-cell">
                                                            @if(isset($filerov[0]) && !empty($filerov[0]))
                                                                @foreach($filerov as $i => $filerovitem)
                                                                    @if(isset($filerovitem) && !empty($filerovitem))
                                                                        ...
                                                                        @if(isset($filerovitemitem->testuuid) && !empty($filerovitemitem->testuuid))
                                                                            @if($filerovitemitem->user_uuid == $usertoaniitem[0]->uuid)
                                                                                ...
                                                                                @if(isset($tar[0]) && !empty($tar[0]))
                                                                                    ...
                                                                                    <a href="{{route('file.mental',['testuuid'=>$filerovitemitem->testuuid,'user_uuid'=>$filerovitemitem->user_uuid,'datauser'=>$targamot,'file'=>0])}}">
                                                                                        {{$targamot}}
                                                                                    </a>
                                                                                    <br>
                                                                                @endif
                                                                ...
                                                                @endforeach
                                                            @endif
                                                            {{--                                                    @if(isset($filerov[0][0]->testuuid))--}}
                                                            {{--                                                        @foreach($filerov as $i => $filerovitem)--}}
                                                            {{--                                                            @if(isset($filerovitem->testuuid) && !empty($filerovitem->testuuid))--}}
                                                            {{--                                                                @if($filerovitem->user_uuid == $usertoaniitem[0]->uuid)--}}
                                                            {{--                                                                    @php($tar = explode('GMT+0400',$filerovitem->datauser))--}}
                                                            {{--                                                                    @if(isset($tar[0]) && !empty($tar[0]))--}}
                                                            {{--                                                                        @php($targamot = gmdate("Y-m-d H:i:s",strtotime($tar[0])))--}}
                                                            {{--                                                            <a href="{{route('file.pasuxfile',['testuuid'=>$filerovitem->testuuid,'user_uuid'=>$filerovitem->user_uuid,'datauser'=>$targamot,'file'=>0])}}">--}}
                                                            {{--                                                                {{$targamot}}--}}
                                                            {{--                                                            </a>--}}
                                                            {{--                                                                        <br>--}}
                                                            {{--                                                                    @endif--}}
