...
@section('section')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <a href="{{route('signal.test.add')}}"> <span class="mdi mdi-plus mdi-48px mdi-dark"></span></a>
                                            ...
                                            @if(isset($testviuv))
                                                @foreach($testviuv as $testviuvitem)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('signal.user',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('user.usergamot',['sigid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('editbase',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-rounded btn-fw"><span
                                                                        class="mdi mdi-file-document-edit"></span>
                                                                    რედაქტირება
                                                        ...
                                                        <td>
                                                            <a href="{{route('delltbase',['dellid'=>$testviuvitem->id])}}">
                                                                <button type="button"
