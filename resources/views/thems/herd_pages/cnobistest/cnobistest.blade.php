...
@section('section')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <a href="{{route('cnobistest.test.add')}}"> <span class="mdi mdi-plus mdi-48px mdi-dark"></span></a>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="order-listing" class="table dataTable no-footer" role="grid"
                                            ...
                                            <tbody>
                                            @if(isset($testviuv))
                                                @foreach($testviuv as $i => $testviuvitem)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="">{{$testviuvitem->row}}</td>
                                                        <td class="sorting_1">
                                                            <a href="{{route('cnobistest.user',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('cnobistest.user.usergamot',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-rounded btn-fw"><span
                                                                        class="mdi mdi-file-document-edit"></span>
                                                                    პასუხები
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('edit.cnobistest',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-rounded btn-fw"><span
                                                                        class="mdi mdi-file-document-edit"></span>
                                                                    რედაქტირება
                                                        ...
                                                        <td>
                                                            <a href="{{route('cnobistest.dell.mental',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
