    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-sample" method="post" action="{{route('edit.mental',['upid'=>$percad->id])}}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="table-sorter-wrapper col-lg-12 table-responsive">
                            ...
                            <table id="sortable-table-2" class="table table-striped">
                                ...
                                <tr>
                                    <th>#</th>
                                    <th class="sortStyle">ტესტის ასო<i class="mdi mdi-chevron-down"></i></th>
                                    <th class="sortStyle">კუთხის გრადუსი<i class="mdi mdi-chevron-down"></i></th>
                                    <th class="sortStyle">სარკისებური<i class="mdi mdi-chevron-down"></i></th>
                                </tr>
                                </thead>
                                <tbody>
{{--                                @dd($percpartviu)--}}
                                @foreach($percpartviu as $i => $sworiitem)
                                    ...
                                    <tr>
                                        <td>{{$i+1}}</td>
                                        <td><input value="{{$sworiitem->testaso}}" class="form-control"
                                                   name="testaso[]"></td>
                                        <td><input value="{{$sworiitem->gradusi}}" class="form-control"
                                                   name="gradusi[]"></td>
                                        <td><input value="{{$sworiitem->revers}}" class="form-control"
                                                   name="revers[]">
                                        </td>
                                    </tr>
                                @endforeach
