...
@section('section')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <a href="{{route('mental.test.add')}}"> <span class="mdi mdi-plus mdi-48px mdi-dark"></span></a>
                                            ...
                                            @if(isset($testviuv))
                                                @foreach($testviuv as $i => $testviuvitem)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="">{{$testviuvitem->rov}}</td>
                                                        <td class="sorting_1">
                                                            <a href="{{route('mental.user',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('user.mental',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-rounded btn-fw"><span
                                                                        class="mdi mdi-file-document-edit"></span>
                                                                    პასუხები
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('edit.mental',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-rounded btn-fw"><span
                                                                        class="mdi mdi-file-document-edit"></span>
                                                                    რედაქტირება
                                                        ...
                                                        <td>
                                                            <a href="{{route('dell.mental',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
