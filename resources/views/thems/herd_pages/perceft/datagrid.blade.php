...
@section('section')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <a href="{{route('perceft.test.ass')}}"> <span class="mdi mdi-plus mdi-48px mdi-dark"></span></a>
                                            ...
                                            @if(isset($testviuv))
                                                @foreach($testviuv as $i => $testviuvitem)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('perceft.user',['dellid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('user.base',['dellid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-rounded btn-fw"><span
                                                                        class="mdi mdi-file-document-edit"></span>
                                                                    პასუხები
                                                        ...
                                                        <td class="sorting_1">
                                                            <a href="{{route('edit.percef',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-rounded btn-fw"><span
                                                                        class="mdi mdi-file-document-edit"></span>
                                                                    რედაქტირება
                                                        ...
                                                        <td>
                                                            <a href="{{route('dell.percef',['upid'=>$testviuvitem->id])}}">
                                                                <button type="button"
