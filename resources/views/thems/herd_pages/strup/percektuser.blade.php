                                ...
                                <div class="list-wrapper">
                                    <ul class="d-flex flex-column-reverse todo-list">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="color"
                                                           @if(isset($pasux->color) && $pasux->color == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    ფერი
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="text"
                                                           @if(isset($pasux->text) && $pasux->text == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    სიტყვა
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="kofiguration"
                                                           @if(isset($pasux->kofiguration) && $pasux->kofiguration == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    კონგულეტურობა
                                        ...
                                        <div class="couples">
                                            <div class="form-group">
                                                ...
                                                <select name="xgerdzi[]">
                                                    ...
                                                    <option value="text">სიტყვა</option>
                                                    <option value="kofiguration">კონგულეტურობა</option>
                                                    <option value="momxpasux">მომხმარებლის პასუხი</option>
                                                    <option value="pasuxdro">პასუხის დრო</option>
                                                    <option value="upasuxtuara">უპასუხა თუ არა</option>
                                                    <option value="sworipasux">ტესტის სწორი პასუხი</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
