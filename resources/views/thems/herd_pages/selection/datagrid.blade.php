...
@section('section')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <a href="{{route('selection.test.add')}}"> <span class="mdi mdi-plus mdi-48px mdi-dark"></span></a>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="order-listing" class="table dataTable no-footer" role="grid"
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1">
                                                    <a href="{{route('selection.user',['upid'=>$testviuvitem->id])}}">
                                                        <button type="button"
                                                ...
                                                <td class="sorting_1">
                                                    <a href="{{route('user.selection',['upid'=>$testviuvitem->id])}}">
                                                        <button type="button"
                                                                class="btn btn-primary btn-rounded btn-fw"><span
                                                                class="mdi mdi-file-document-edit"></span>
                                                            პასუხები
                                                ...
                                                <td class="sorting_1">
                                                    <a href="{{route('edit.selection',['upid'=>$testviuvitem->id])}}">
                                                        <button type="button"
                                                                class="btn btn-primary btn-rounded btn-fw"><span
                                                                class="mdi mdi-file-document-edit"></span>
                                                            რედაქტირება
                                                ...
                                                <td>
                                                    <a href="{{route('dell.selection',['upid'=>$testviuvitem->id])}}">
                                                        <button type="button"
