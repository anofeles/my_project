                                    ...
                                    <ul class="d-flex flex-column-reverse todo-list">
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="variant"
                                                           @if(isset($pasux->variant) && $pasux->variant == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    დისტრაქტორის სტიმულის ტიპი
                                                </label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox" name="dashoreba"
                                                           @if(isset($pasux->dashoreba) && $pasux->dashoreba == 'on')
                                                           checked="checked"
                                                        @endif
                                                    >
                                                    დაშორება
                                    ...
                                    <div class="couples-holder">
                                        <div class="couples">
                                            <div class="form-group">
                                                ...
                                                <select name="xgerdzi[]">
                                                    <option value=""></option>
                                                    <option value="variant">დისტრაქტორის სტიმულის ტიპი</option>
                                                    <option value="dashoreba">დაშორება</option>
