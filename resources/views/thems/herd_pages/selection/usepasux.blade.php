                                                                    ...
                                                                    @if(isset($filerovitemitem->testuuid) && !empty($filerovitemitem->testuuid))
                                                                        @if($filerovitemitem->user_uuid == $usertoaniitem[0]->uuid)
                                                                            ...
                                                                            @if(isset($tar[0]) && !empty($tar[0]))
                                                                                ...
                                                                                <a href="{{route('file.selection',['testuuid'=>$filerovitemitem->testuuid,'user_uuid'=>$filerovitemitem->user_uuid,'datauser'=>$targamot,'file'=>0])}}">
                                                                                    {{$targamot}}
                                                                                </a>
                                                                                <br>
                                                                            @endif
...
{{--                                                                            <a href="{{route('file.selection',['testuuid'=>$filerovitem->testuuid,'user_uuid'=>$filerovitem->user_uuid,'datauser'=>$targamot,'file'=>0])}}">--}}
{{--                                                                                {{$targamot}}--}}
{{--                                                                            </a>--}}
{{--                                                                            <br>--}}
{{--                                                                        @endif--}}
